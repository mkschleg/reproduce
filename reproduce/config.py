...
def _make_dataclass_core(base_cls, name, obj, type_key, suffix, n_context_args):
    ...
    for pname, param in sig.parameters.items():
        ...
        elif typing.get_origin(typ) == dict:
            flds.append((pname, typ, field(default_factory=dict)))
        elif typing.get_origin(typ) == list:
            flds.append((pname, typ, field(default_factory=list)))
        else:
